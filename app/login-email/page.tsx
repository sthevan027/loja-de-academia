        ...
        <div className="flex w-full flex-col justify-center bg-white px-4 sm:px-6 md:px-8 lg:w-1/2 lg:px-12">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-10 text-center">
              <h2 className="text-3xl font-bold text-gray-900">Entre com seu email</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden w-1/2 bg-black lg:block">
        <div className="relative h-full w-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/30 p-12 text-white">
            <h1 className="mb-6 text-5xl font-bold">POWER GYM</h1>
      ...
      <div className="flex w-full flex-col justify-center bg-white px-4 sm:px-6 md:px-8 lg:w-1/2 lg:px-12">
        <div className="mx-auto w-full max-w-md">
          <div className="mb-2">
            <Link
              href="/login"
              className="inline-flex items-center text-sm font-medium text-gray-600 hover:text-red-600"
            >
